...
exports.default = _default;
},{"./set-share-url":"js/set-share-url.js"}],"js/before-after-card.js":[function(require,module,exports) {
"use strict";
...
function _default() {
  ...
  var imageParent = document.querySelector('.image-parent');
  var indicator = document.querySelector('.indicator');
  var imageMask = document.querySelector('.masked__img');
  var indicatorDragger = document.querySelector('.indicator__bubble');
  var dragInterval = null;
  console.log('init');

  var initSize = function initSize() {
    var parentWidth = imageParent.offsetWidth;
  ...
  var runDragger = function runDragger(event, flag) {
    var count = 0;
  ...
  indicator.addEventListener('mousedown', function (event) {
    return runDragger(event, true);
  });
  window.addEventListener('mouseup', function (event) {
    return runDragger(event, false);
  });
}
...
var _beforeAfterCard = _interopRequireDefault(require("./before-after-card"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _beforeAfterCard.default)(); // fetchDevice();
},{"./fetch-device":"js/fetch-device.js","./before-after-card":"js/before-after-card.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
